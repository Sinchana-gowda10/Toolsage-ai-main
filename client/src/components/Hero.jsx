...
>Unlock Your Creativity <br /> with Smart <span className='text-primary'>AI Tools</span></h1>
            <p className='mt-4 max-w-xs sm:max-w-lg 2xl:max-w-xl m-auto max-sm:text-xs text-gray-600'
>Boost productivity and creativity with intelligent tools for writing,
            image generation, and workflow automation — all in one place.</p>
        </div>
