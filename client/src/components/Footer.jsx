...
const Footer = () => {
  return (
    ...
    <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
        <div className="md:max-w-96">
            ...
            <p className="mt-6 text-sm" >
                Let AI Light the Way – ToolSage at Your Service  <br />
                Transform your content creation with the intelligence of ToolSage AI.
                From ideas to execution, let smart tools do the heavy lifting.
    ...
    <p className="pt-4 text-center text-xs md:text-sm pb-5">
        Copyright 2025 © ToolSage AI. All Right Reserved.
    </p>
</footer>
  )
}
